...
public class DmcInfoMessage
extends DmcActivity {
    private String infoMessageText;

    @Override
    public void onCreate(Bundle bundle) {
        this.LOG_TAG = "DmcInfoMessage";
        DmcLog.v(this.LOG_TAG, "onCreate()");
        super.onCreate(bundle);
        this.infoMessageText = this.getIntent().getStringExtra("uiAlertTextExtra");
    ...
    public void setContentView(int n) {
        ...
        ((TextView)this.findViewById(2131230720)).setText((CharSequence)this.infoMessageText);
    }
}
