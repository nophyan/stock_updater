 ...
 */
public class InitSchedSetting
extends DmcActivity {
    private static final String LOG_TAG = "InitSchedSetting";
    ...
    public void onCreate(Bundle bundle) {
        DmcLog.v("InitSchedSetting", "onCreate()");
    ...
    public void setContentView(int n) {
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                InitSchedSetting.this.dHH = TimeUtils.getHrFromIndex(InitSchedSetting.this.timeSlots, InitSchedSetting.this.np.getValue());
                InitSchedSetting.this.dMM = TimeUtils.getMinFromIndex(InitSchedSetting.this.timeSlots, InitSchedSetting.this.np.getValue());
                TimeUtils.setDefaultScheduleTime(InitSchedSetting.this.mContext, InitSchedSetting.this.dHH, InitSchedSetting.this.dMM);
                button.setClickable(false);
                InitSchedSetting.this.a.sendMessage(2, view.getTag().toString());
            }
        });
    }
